...
public class TestEcurie {
	...
	// Enregistre une ecurie dans l'application
		...
		public void testEnregistrerEcurieEtEquipes() {
			...
			e.addEquipe(eq);
			assertEquals(Ecurie.enregistrerEcurie(e),1);
			assertEquals(Ecurie.supprimerEcurie(e),1);
		}
		...
		/*
		 * @Test public void testGetAllEcuries() throws Exception { List<Ecurie> liste =
		 * Ecurie.getAllEcuries(); assertEquals(liste.get(0).getNom(), "Cloud9");
