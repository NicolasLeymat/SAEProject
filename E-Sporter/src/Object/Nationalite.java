...
public enum Nationalite {
	...
	EE("EE", "Estonie"),
	ET("ET", "Ethiopie"),
	FK("FK", "Îles Falkland (Malvinas)"),
	FO("FO", "Îles Féroé"),
	FJ("FJ", "Fidji (République de)"),
	FI("FI", "Finlande"),
	FR("FR", "France"),
	...
	YT("YT", "Mayotte"),
	MX("MX", "Mexique"),
	FM("FM", "Micronésie (États fédérés de)"),
	MD("MD", "Moldavie (République de)"),
	MC("MC", "Monaco"),
	MN("MN", "Mongolie"),
	ME("ME", "Monténégro"),
	MS("MS", "Montserrat"),
	...
	SL("SL", "Sierra Leone"),
	SG("SG", "Singapour"),
	SX("SX", "Sint Maarten (partie hollandaise)"),
	SK("SK", "Slovaquie"),
	SI("SI", "Slovénie"),
	SB("SB", "Îles Salomon"),
	SO("SO", "Somalie"),
	...
	VN("VN", "Vietnam"),
	VG("VG", "Iles Vierges (Britanniques)"),
	VI("VI", "Îles Vierges (États-Unis)"),
